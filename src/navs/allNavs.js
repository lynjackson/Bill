...
import Meny from '../pages/menu2.js';
...
export const TabNav = createBottomTabNavigator({
  Menu: {
    screen: TabStackNav,
    navigationOptions: {
            tabBarLabel: <View style={{alignItems: 'center', position:'relative', marginBottom: 5}}><Ionicons name="md-book" size={24} style={{color:'white'}}/><Text style={{color:'white', fontFamily: 'Roboto', letterSpacing:2, fontSize: 12,}}>MENU</Text></View>,
        },
  },
  Cart: {
    screen: Cart,
    navigationOptions: {
            tabBarLabel: <View style={{alignItems: 'center', position:'relative', marginBottom: 5,   }}><Ionicons name="md-cart" size={24} style={{color:'white'}}/><Text style={{color:'white', fontFamily: 'Roboto', letterSpacing:2, fontSize: 12,}}>CART</Text></View>
  ...
  Order: {
    screen: Order,
    navigationOptions:{
      tabBarLabel: <View style={{alignItems: 'center', position:'relative', marginBottom:5, justifyContent: 'flex-start'}}><Ionicons name="md-color-wand" size={24} style={{color:'white'}}/><Text style={{fontFamily: 'Roboto', letterSpacing:2, fontSize: 12, color: 'white'}}>TABLE</Text></View>,
    }
  }
},
{
